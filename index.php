...
if (!empty($_POST["submitButton"])) {
    ...
    if (empty($error_message)) {
        ...
        try {
            ...
            //SQL作成
            $statment = $pdo->prepare("INSERT INTO `z-master` (username, comment, post_date) VALUES (:username, :comment, :current_date)");
...
//DBからコメントデータを取得する
$sql = "SELECT username, comment, post_date FROM `z-master` ORDER BY post_date ASC";
